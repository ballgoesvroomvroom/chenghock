...
function SocialsCardRow() {
	return (
		<div className="flex flex-wrap gap-4 p-4 md:p-8 my-12 sm:mt-24">
			{
				...
				["Email", SOCIALS_EMAIL, "hi@chenghock.com"]].map((item, i) => 
					<a className={`p-3 group inline-flex flex-col gap-3 border-solid border-black border-2`} href={item[1]} target="_blank">
						<div className="inline-flex flex-row justify-between gap-4">
							<p className="grow font-bold text-lg">{item[0]}</p>
							<svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-opacity">
								...
								<line x1="136" x2="216" y1="120" y2="40" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
